...
export default {
  ...
  setup() {
    const institutions = ref([
            ...
            {group: 'kuleuven', inst_group: 'kulloc,KULeuven_regio)', sort: 0, name_en: '', name: 'KU Leuven, Campus Leuven, Kortrijk, Antwerpen, Brugge en Sint-Lucas Brussel en TDC Gent', code: 'KULeuven', vid: 'KULeuven', width: '80px', display: true, vidve:'32KUL_KUL:KULeuven',fullurl:'https://limo.libis.be/kuleuvencampussen'},
            ...
            {group: 'libisnet', inst_group: 'reli', sort: '', name_en: '', name: 'Documentatie- en Onderzoekscentrum voor Religie, Cultuur en Samenleving', code: 'KADOC', vid: 'KADOC', width: '80px', display: true, vidve:'32KUL_KADOC:KADOC',fullurl:'https://limo.libis.be/KADOC'},
            ...
            {group: 'libisnet', inst_group: '', sort: '', name_en: '', name: 'European Central Bank', code: 'ECB', vid: 'ECB', width: '120px', display: true, vidve:'49ECB_INST:ECB',fullurl:'https://limo.libis.be/ECB'},
