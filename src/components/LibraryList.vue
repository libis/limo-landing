...
export default {
  ...
  setup() {
    const institutions = ref([
            {group: 'libisnet', inst_group: '', sort: '', name_en: '', name: 'AB', code: 'AB', vid: 'AB', width: '60px', display: false, vidve:'32KUL_KHL:UCLL',fullurl:''},
            {group: 'libisnet', inst_group: '', sort: '', name_en: '', name: 'ACV', code: 'ACV', vid: 'ACV', width: '60px', display: true, vidve:'32KUL_ACV:ACV',fullurl:''},
            ...
            {group: 'kuleuven', inst_group: 'kulloc,KULeuven_regio)', sort: 0, name_en: '', name: 'KU Leuven, Campus Leuven, Kortrijk, Antwerpen, Brugge en Sint-Lucas Brussel en TDC Gent', code: 'KULeuven', vid: 'KULeuven', width: '80px', display: true, vidve:'32KUL_KUL:KULeuven',fullurl:''},
            {group: 'kuleuven', inst_group: 'kulloc,KULeuven_regio', sort: 2, name_en: '', name: 'KU Leuven incl. gemengde campussen', code: 'kuleuven', vid: 'KULeuvenRegional', width: '80px', display: true, vidve:'32KUL_KUL:REGIONAL',fullurl:''},
            ...
            {group: 'libisnet', inst_group: 'reli', sort: '', name_en: '', name: 'Documentatie- en Onderzoekscentrum voor Religie, Cultuur en Samenleving', code: 'KADOC', vid: 'KADOC', width: '80px', display: true, vidve:'32KUL_KADOC:KADOC',fullurl:'http://limo.libis.be/KADOC'},
            {group: 'libisnet', inst_group: 'reli', sort: '', name_en: '', name: 'Grootseminarie Gent', code: 'GSG', vid: 'GSG', width: '60px', display: true, vidve:'32KUL_GSG:GSG',fullurl:''},
            {group: 'libisnet', inst_group: 'reli', sort: '', name_en: '', name: 'Grootseminarie Brugge', code: 'GSB', vid: 'GSB', width: '30px', display: true, vidve:'32KUL_GSB:GSB',fullurl:''},
            {group: 'libisnet', inst_group: '', sort: '', name_en: '', name: 'European Central Bank', code: 'ECB', vid: 'ECB', width: '120px', display: true, vidve:'49ECB_INST:ECB',fullurl:'http://limo.libis.be/ECB'},
            {group: 'libisnet', inst_group: 'music', sort: '', name_en: '', name: 'Muziekcatalogus [LUCA]', code: 'lucawenk', vid: 'LUCA_MUSIC', width: '200px', display: true,vidve:'32KUL_LUCAWENK:LUCA_MUSIC',fullurl:'http://limo.libis.be/LUCA_MUSIC'},
            {group: 'libisnet', inst_group: 'music', sort: '', name_en: '', name: 'Muziekcatalogus [KU Leuven]', code: 'kuleuven', vid: 'KULEUVEN_MUSIC', width: '200px', display: true,vidve:'32KUL_KUL:KULeuven_music',fullurl:'http://limo.libis.be/KULEUVEN_MUSIC'},
            ...
            {group: 'libisnet', inst_group: 'bibl', sort: '', name_en: '', name: 'DokS', code: 'kuleuven', vid: 'DOKS', width: '80px', display: true, vidve:'32KUL_LIBIS_NETWORK:DOKS_UNION',fullurl:'http://limo.libis.be/DOKS'},
            {group: 'libisnet', inst_group: 'bibl', sort: '', name_en: '', name: 'Jesuit Armarium', code: 'kadoc', vid: 'JESUITS', width: '80px', display: true, vidve:'32KUL_KUL:JESUITS',fullurl:'http://limo.libis.be/JESUITS'},
