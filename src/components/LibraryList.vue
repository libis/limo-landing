...
export default {
  ...
  setup() {
    const institutions = ref([
            ...
            {group: 'kuleuven', inst_group: 'kulloc,KULeuven_regio)', sort: 0, name_en: '', name: 'KU Leuven', code: 'KULeuven', vid: 'KULeuven', width: '80px', display: true, vidve:'32KUL_KUL:KULeuven',fullurl:'https://limo.libis.be/kuleuvencampussen'},
